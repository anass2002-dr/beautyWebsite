            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                  <form class='forms-sample' method='post' action='update_p.php' enctype='multipart/form-data'>
                    ...
                    <div class="mb-3 " id="div_links">
                      <?php
                      $query_collection = "select * from product_collection_photos where PRODUCT_ID=$id";
